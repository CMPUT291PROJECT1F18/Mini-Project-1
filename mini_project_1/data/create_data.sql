...
insert into members values
        ...
        ('maria@xyz.org', 'Maria Calzone', '780-382-3847', 'bar'),
        ('the99@oil.com', 'Wayne Gretzky', '780-382-4382', 'hunter'),
        ('connor@oil.com', 'Connor Mcdavid', '587-839-2838', 'passw'),
        ('don@mayor.yeg', 'Don Iveson', '780-382-8239', 'foo1'),
        ('darryl@oil.com', 'Darryl Katz', '604-238-2380', 'foo2'),
        ('reilly@esks.org', 'Mike Reilly', '780-389-8928', 'foo3'),
        ('mess@marky.mark', 'Mark Messier', '516-382-8939', 'foo4'),
        ('kd@lang.ca', 'K. D. Lang', '874-384-3890', 'foo5'),
        ('nellie@five.gov', 'Nellie McClung', '389-930-2839', 'foo7'),
        ('marty@mc.fly', 'Micheal J. Fox', '780-382-3899', 'foo8'),
        ('cadence@rap.fm', 'Roland Pemberton', '780-938-2738', 'foo9'),
        ('mal@serenity.ca', 'Nathan Fillion', '780-389-2899', 'foo10'),
        ('john@acorn.nut', 'John Acorn', '780-389-8392', 'foo11');
...
insert into bookings values
        ...
        (13, 'bob@123.ca', 42, null, 1, null, null);
